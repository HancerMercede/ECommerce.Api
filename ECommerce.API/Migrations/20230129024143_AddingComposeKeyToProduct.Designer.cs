...
namespace ECommerce.API.Migrations
{
    ...
    [Migration("20230129024143_AddingComposeKeyToProduct")]
    partial class AddingComposeKeyToProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ECommerce.API.Entities.InvoiceDetail", b =>
                {
                    ...
                    b.Property<int>("ProductFactorId")
                        .HasColumnType("int");

                    b.Property<Guid>("ProductFruitId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProductId", "ProductFactorId", "ProductFruitId");
            ...
            modelBuilder.Entity("ECommerce.API.Entities.InvoiceDetail", b =>
                {
                    ...
                    b.HasOne("ECommerce.API.Entities.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId", "ProductFactorId", "ProductFruitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
