...
namespace ECommerce.API.Migrations
{
    ...
    [Migration("20230128231734_AddingCollectionProductsToUnits")]
    partial class AddingCollectionProductsToUnits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductUnits", b =>
                {
            ...
            modelBuilder.Entity("ProductUnits", b =>
                {
                    b.HasOne("ECommerce.API.Entities.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerce.API.Entities.Units", null)
                        .WithMany()
